...
class Admin extends Model {
    ...
    public function postAdd($post) {
        ...
        $query_string = "INSERT INTO `posts` (name, description, text ) VALUES ('$params[name]', '$params[description]', '$params[text]')";
    ...
    public function postEdit($post, $id) {
		...
		return $this->db->query("UPDATE `posts` SET name = '$params[name]', description = '$params[description]', text = '$params[text]' WHERE `id`= $id");
	}
